...
HomeViewModel @Inject constructor(
    ...
    private val _searchResponse = MutableLiveData<NetworkResult<ProductsByRestaurantResponse>>()
    ...
    val searchResponse: LiveData<NetworkResult<ProductsByRestaurantResponse>>
        get() = _searchResponse
