package com.specindia.ecommerce.ui.dashboard.viewmodel
...
import com.specindia.ecommerce.util.Constants.Companion.RECENT
...
class DataViewModel @Inject constructor(
    ...
    fun saveRecentList(value: String) {
        viewModelScope.launch {
            repository.putString(RECENT, value)
        }
    }
    ...
    fun getRecentList(): String? = runBlocking {
        repository.getString(RECENT)
    }
