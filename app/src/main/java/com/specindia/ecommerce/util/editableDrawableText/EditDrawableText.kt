package com.specindia.ecommerce.util.editableDrawableText
...
class EditDrawableText(context: Context, attrs: AttributeSet) : TextInputEditText(context, attrs) {
    ...
    private fun parseAttributes(obtainStyledAttributes: TypedArray) {
        isDrawableShownWhenTextIsEmpty =
            obtainStyledAttributes.getBoolean(R.styleable.EditDrawableText_isDrawableShownWhenTextIsEmpty,
                isDrawableShownWhenTextIsEmpty);
    ...
    private fun hasDrawable(value: Boolean) {
        ...
        if (!isDrawableShownWhenTextIsEmpty) this.setCompoundDrawablesWithIntrinsicBounds(0,
            0,
            0,
            0)
        invalidate()
...
//                        0,
//                        0)
//                } else editText.setCompoundDrawables(drawableLeft,
//                    drawableTop,
